...
const PropertyDetails = () => {
  ...
  //get the house bqased on the id
  ...
  return <section>
    <div className='container mx-auto min-h-[800px] mb-14'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='text-3xl font-semibold text-orange-600'>₹ {house.price}</div>
      </div>
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            ...
            <textarea className='border border-gray-300 focus:border-violet-700 outline-none resized-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message*' defaultValue="Hello, I am Intersted In This House/Apartment"></textarea>
            <div className='flex gap-x-2'>
              <button className='bg-red-700 hover:bg-red-800 text-white rounded p-4 text-sm w-full transition'>Send Messages</button>
            
              <button className='bg-green-700 hover:bg-green-800 text-white rounded p-4 text-sm w-full transition'
              // "border border-green-700 text-green-700 hover:border-green-500 hover:text-green-500 rounded p-4 text-sm w-full transition"
              >Call</button>
            </div>
